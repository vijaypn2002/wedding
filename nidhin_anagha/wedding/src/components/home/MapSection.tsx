            ...
            <div className="container max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-32 space-y-8">
                    <motion.p
                        ...
                        className="text-accent uppercase tracking-[0.8em] text-[10px]"
                    >
                        Directions
                    </motion.p>
                    <motion.h2 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center max-w-6xl mx-auto">
                    ...
                    <motion.div 
                        ...
                        className="relative aspect-video rounded-sm overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] border border-white/10 group"
                    >
                        <iframe
                    ...
                    <div className="space-y-12">
                        <div className="space-y-8">
                            <div className="flex items-center gap-6">
                                <div className="w-12 h-12 rounded-full glass-gold flex items-center justify-center text-accent">
                                    <MapPin size={24} />
                                </div>
                                <h3 className="text-4xl font-serif text-white italic">Makkiyad HOLY FACE auditorium, Wayanad</h3>
                            </div>
